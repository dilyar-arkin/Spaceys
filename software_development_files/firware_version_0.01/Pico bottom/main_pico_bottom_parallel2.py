...
async def initialize():
    ...
    print(f"Failed to initialize after {init_attempts} attempts but proceeded.")
    logger2.error(f"Failed to initialize after {init_attempts} attempts but proceeded.")
    return SD, i2c0, imu, rf_driver, peltier, temperature_sensor
